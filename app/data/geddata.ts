...
export const gedQuestions: QuizQuestion[] = [
  ...
  { id: "ged80", question: '<img src="https://res.cloudinary.com/dhoecxgs7/image/upload/v1787796994/unemployment_zrsy6g.png" alt="Unemployment rate table 2020-2023" class="w-full max-w-xl mx-auto mb-4 rounded-lg" /><p class="text-center">A politician says, "The unemployment rate declined every single year in the table." Which evaluation is most accurate?</p>', options: ["The claim is fully supported.", "The claim is not fully supported because the rate was unchanged from 2022 to 2023.", "The table contains no unemployment information.", "The claim cannot be evaluated using data."], correctAnswer: "The claim is not fully supported because the rate was unchanged from 2022 to 2023." },
];