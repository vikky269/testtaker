              ...
              <>
                ...
                <div className="mb-4">
                  ...
                  <p className="text-lg text-green-700">
                    ELA Score: {calculateSectionScore("ela") !== null ? `${calculateSectionScore("ela")}%` : "Skipped"}
                  </p>
                  <p className="text-lg text-purple-700">
                    Science Score: {calculateSectionScore("science") !== null ? `${calculateSectionScore("science")}%` : "Skipped"}
                  </p>
                </div>
              </>
            ) : (
