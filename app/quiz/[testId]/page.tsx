...
export default function Quiz() {
  ...
  //   if (mathStartTime)      dur.mathDuration    = Math.round(((mathEndTime    || now) - mathStartTime)        / 1000);
  //   if (elaStartTime)       dur.elaDuration     = Math.round(((elaEndTime     || now) - elaStartTime)         / 1000);
  //   if (scienceStartTime)   dur.scienceDuration = Math.round(((scienceEndTime || now) - scienceStartTime)     / 1000);
  //   if (totalTestStartTime) dur.totalDuration   = Math.round(((totalTestEndTime || now) - totalTestStartTime) / 1000);
  ...
  //   localStorage.setItem("testDurations", JSON.stringify(dur));
