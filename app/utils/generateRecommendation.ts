...
// // ── Learning Category Logic (from image 2) ──────────────────
...
// export const getPackageRecommendation = (s: StudentData): Package => {
//   const math    = s.math_score ?? 0;
//   const ela     = s.ela_score ?? 0;
//   const science = s.science_score ?? 0;

//   const needsMath    = math < 70;
//   const needsEla     = ela > 0 && ela < 70;
//   const needsScience = science > 0 && science < 70;

//   // Package 1: Math only
//   if (!needsEla && !needsScience) return {
//     name: 'Package 1 – Mathematics Focus',
...
//     rationale: 'Based on the evaluation, the student will benefit most from focused mathematics support complemented by coding to build logical thinking and problem-solving skills.',
//   };

//   // Package 2: Math + ELA
//   if (needsEla && !needsScience) return {
//     name: 'Package 2 – Mathematics & ELA',
//     subjects: ['Mathematics', 'English Language Arts', 'Coding'],
//     hours: [
//       { subject: 'Mathematics',             hours: '2 hours per week (1-hour sessions twice weekly)' },
...
//     rationale: 'The student shows a need for support in both Mathematics and English Language Arts. This package provides structured sessions in both subjects while introducing coding to strengthen overall reasoning skills.',
//   };

//   // Package 3: Math + Science + Coding
//   if (!needsEla && needsScience) return {
//     name: 'Package 3 – Mathematics, Science & Coding',
//     subjects: ['Mathematics', 'Science', 'Coding'],
//     hours: [
//       { subject: 'Mathematics', hours: '2 hours per week (1-hour sessions twice weekly)' },
...
//     ],
//     totalHours: '4 hours per week',
//     rationale: 'To support balanced STEM development, this package combines structured mathematics support with science and coding sessions to build analytical thinking and problem-solving abilities.',
//   };

//   // Package 4: All subjects
//   return {
//     name: 'Package 4 – Comprehensive Programme',
//     subjects: ['Mathematics', 'English Language Arts', 'Science', 'Coding'],
//     hours: [
//       { subject: 'Mathematics',             hours: '2 hours per week (1-hour sessions twice weekly)' },
//       { subject: 'English Language Arts',   hours: '1 hour per week' },
//       { subject: 'Science',                 hours: '1 hour per week' },
...
//     rationale: 'This comprehensive package addresses all subject areas where the student requires support. The balanced programme ensures no learning gap is left unaddressed while building confidence across Mathematics, ELA, Science, and Coding.',
//   };
// };
...
//     return `${firstName} is still developing foundational math skills and would benefit from structured support to strengthen core concepts. While this score indicates areas of need, her attentiveness and willingness to attempt problems show strong learning potential.`;
//   }
//   if (subject === 'ela') {
//     if (score >= 80) return `${firstName} performed very well in ELA, demonstrating solid comprehension, reasoning, and communication skills. This strength supports her overall academic confidence and ability to understand instructions across subjects.`;
...
//     if (score >= 60) return `${firstName}'s science performance reflects good understanding and curiosity about scientific concepts. With guided practice, she can further improve analytical thinking and problem-solving skills in this area.`;
...
// // ── Main PDF Generator ───────────────────────────────────────
// export const generateRecommendationPDF = (s: StudentData, instructorName = 'Isaac Salako') => {
...
//   const subjects: { name: string; score: number | null; key: 'math' | 'ela' | 'science'; color: [number,number,number]; bg: [number,number,number] }[] = [
...
//   const catLines = doc.splitTextToSize(category.description, cW - 50);
...
//   doc.text(`${firstName} fits well within our ${category.name} category; ${category.description}`, margin + 44, y + 8, { maxWidth: cW - 48 });
